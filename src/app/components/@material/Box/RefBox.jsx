...
import { useForwardingRef } from '../hooks/useForwardingRef';
...
export const RefBox = forwardRef(({ tag, ...props }, ref) => {

  const [forwardRef] = useForwardingRef(ref);
  ...
  return (
    <Tag {...otherProps} ref={forwardRef} className={className} />
  );
});
