...
export const Content = withRouter((props) => {
  return (
    <Div>
      <Switch>
        <Route
          path={`/${Routes.ROUTE_EXTERNAL}/${Routes.ROUTE_CONFIDENTIALITY}`}
          component={Confidentiality}
        />
        <Route
          path={`/${Routes.ROUTE_EXTERNAL}/${Routes.ROUTE_LEGALDISCLAIMING}`}
          component={LegalDisclaimer}
        />
        <Route
          path={`/${Routes.ROUTE_EXTERNAL}/${Routes.ROUTE_TERMOFSERVICE}`}
