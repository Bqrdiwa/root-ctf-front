...
import SolvedChart from './solvedChart/chart';
import CategoryChart from './categoryChart/chart';
...
export default connect(mapStateToProps)(remountOnLanguage(Statistics))
