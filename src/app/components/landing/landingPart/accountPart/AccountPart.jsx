...
export const AccountPart = withRouter((props) => {
  ...
  return (
    <Div className="Content-External">
      <MainBox
        className="mainbox-external Content-External"
        color="black"
        width="50%"
      >
        <Switch>
          <Route
            path={`/${Routes.ROUTE_EXTERNAL}/${Routes.ROUTE_EXTERNAL_LOGIN}`}
            component={Login}
          />
          <Route
            path={`/${Routes.ROUTE_EXTERNAL}/${Routes.ROUTE_EXTERNAL_FORGETPASSWORD}`}
            component={ForgetPassword}
          />
          <Route
            path={`/${Routes.ROUTE_EXTERNAL}/${Routes.ROUTE_EXTERNAL_RESETPASSWORD}`}
            component={ResetPassword}
          />
          <Route
            path={`/${Routes.ROUTE_EXTERNAL}/${Routes.ROUTE_EXTERNAL_ACTIVATE}`}
            component={Active}
          />
      ...
      <MainBox
        className="py-5 mainbox-external content-discription "
        color="black"
        width="50%"
      >
        <Div className="content-text">
          ...
          <H priority="4" className="text-color-leftpart">
            {lang.accountpartMessage2}
          </H>
        </Div>
      </MainBox>
    </Div>
